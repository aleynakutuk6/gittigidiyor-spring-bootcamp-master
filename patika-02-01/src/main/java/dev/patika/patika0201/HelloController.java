...
public class HelloController {
    ...
    public String calculate( @PathParam("num1") int num1, @PathParam("num2") int num2, @PathVariable String operation) {
        int res = 0;

        if(operation.equals("+")) res = num1 + num2;
        else if(operation.equals("-")) res = num1 - num2;
        else if(operation.equals("/")) res = num1 / num2;
        else if(operation.equals("*")) res = num1 * num2;
